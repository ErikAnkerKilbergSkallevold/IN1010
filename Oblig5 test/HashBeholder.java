...
public class HashBeholder {
    ArrayList<HashMap<String,SubSequence> > alleH = new ArrayList<HashMap<String,SubSequence> >();
    int  antall = 0;

  public static HashMap<String,SubSequence> flett (HashMap<String,SubSequence> subSeqHash1,
